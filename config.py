...
# Bot and owner info
OWNER_USERNAME = getenv("OWNER_USERNAME", "HeartStealer_X")
BOT_USERNAME = getenv("BOT_USERNAME", "Yukiimusicbot")
BOT_NAME = getenv("BOT_NAME", "yuki")
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002652452357))
...
# Git
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/hkmusic/Yukimusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/hartsteeler")
